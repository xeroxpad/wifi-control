...
class GcpLogger {
  ...
  getErrorHandler() {
    return __async(this, null, function* () {
      ...
      let helpInstructions = yield (0, import_utils.loggingDeniedHelpText)();
...
`
        ...
        if (err) {
          import_logging.logger.init(
            yield new GcpLogger(this.config).getLogger((0, import_genkit.getCurrentEnv)())
          );
