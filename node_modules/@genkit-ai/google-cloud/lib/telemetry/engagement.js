...
class EngagementTelemetry {
  constructor() {
     ...
     */
    this._N = import_metrics.internalMetricNamespaceWrap.bind(null, "engagement");
    this.feedbackCounter = new import_metrics.MetricCounter(this._N("feedback"), {
      description: "Counts calls to genkit flows.",
      valueType: import_api.ValueType.INT
    });
    this.acceptanceCounter = new import_metrics.MetricCounter(this._N("acceptance"), {
  ...
  writeUserFeedback(span, projectId) {
    ...
    const metadata = __spreadProps(__spreadValues({}, (0, import_utils.createCommonLogAttributes)(span, projectId)), {
