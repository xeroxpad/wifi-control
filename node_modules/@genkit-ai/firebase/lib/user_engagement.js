...
function collectUserEngagement(userEngagement) {
  return __async(this, null, function* () {
    var _a, _b;
    if ((_a = userEngagement.feedback) == null ? void 0 : _a.value) {
      const metadata = {
      ...
      yield (0, import_tracing.appendSpan)(
    ...
    if ((_b = userEngagement.acceptance) == null ? void 0 : _b.value) {
      yield (0, import_tracing.appendSpan)(
        userEngagement.traceId,
        userEngagement.spanId,
        {
